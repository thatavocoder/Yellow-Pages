...
function submitForm() {
    ...
    displayData(stateval, categoryval, classval, typeval, courseval, religionval, genderval);
}

function displayData(stateval, categoryval, classval, typeval, religionval, courseval, genderval) {
    nUrl = '?state=' + stateval + '&category=' + categoryval + '&sclass=' + classval + '&stype=' + typeval + '&course=' + courseval + '&religion=' + religionval + '&gender=' + genderval
...
document.getElementsByTagName('body').onload(filterList())
displayData('', '', 'UG', '', '', '', 'All');