var url = 'https://yellow-pages-backend.herokuapp.com/api/loans/active/?'
var scholarships;
var page = 1
...
async function getfields(url) {
    ...
    var filterFields = 'https://yellow-pages-backend.herokuapp.com/api/loans/filterFields/'
...
form.addEventListener('submit', (e) => {
    e.preventDefault();
    url = "https://yellow-pages-backend.herokuapp.com/api/loans/filter/?"
    var filterVal = {
...
search.addEventListener('submit', (e) => {
    e.preventDefault();
    page = 1
    url = "https://yellow-pages-backend.herokuapp.com/api/loans/search/?"
    var filterVal = {
